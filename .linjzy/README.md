...
- 卡片底部仅显示最近 24 轮的精细色块：绿=通过、红=答错、橙=异常、灰=未测，色块上下无额外文案。点击或键盘激活任意历史色块，可查看当轮题目、答案、模型回复、耗时、首字延迟、Token 用量、HTTP 状态、接口及客户端版本；旧记录未保存的指标留空。前端每 30 秒刷新，路由仍只依据最新有效通过结果。
